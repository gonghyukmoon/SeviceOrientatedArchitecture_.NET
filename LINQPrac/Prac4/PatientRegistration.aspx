<%@ Page Title="Patient Registration" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="PatientRegistration.aspx.cs" Inherits="Prac4._Default" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <p>
     <asp:Label ID="Label7" runat="server" Text="First Name :   "></asp:Label><asp:TextBox ID="txtSearchFirstName" runat="server"></asp:TextBox><asp:Label ID="Label8" runat="server" Text="Last Name :   "></asp:Label>
